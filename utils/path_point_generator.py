...
def generate_path_points(path_points, obstacles):
    ...
    axis_limit = int(parser['Plot Axes']['x_end'])

    ## Generates all points in a n x n grid

    # for i in range(1, axis_limit):
    #     for j in range(1, axis_limit):
    #         if not _path_point_near_obstacle(i, j, obstacles):
